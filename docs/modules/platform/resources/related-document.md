...
Əlaqəli sənədlər resursu platforma və sistem modulunda aid olduğu məlumat və əməliyyatları idarə edir.

:::info Kontekst
`Bearer` JWT və ya integration token · tenant və filial scope-u · `{resource}`
:::

## Resursun işləmə qaydası

**Məqsəd və sərhəd.** Əlaqəli sənədlər resursu platforma və sistem modulunda aid olduğu məlumat və əməliyyatları idarə edir. Bu resurslar UI və platform davranışını idarə edir; biznes sənədinin domain kontraktını əvəz etmir.
...
### Əlaqəli sənədlər siyahısını al

**Endpoint** · `GET /api/v1/documents/{resource}/{id}/related-documents`
...
{
  "status": "success",
  "message": "Əlaqəli sənədlər uğurla gətirildi.",
  "data": [
    {
      "id": "22222222-2222-4222-8222-222222222222"
    }
