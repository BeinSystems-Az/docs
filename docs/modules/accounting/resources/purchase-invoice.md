...
Təchizatçı kreditor borcunu və alış üzrə vergi/mühasibat nəticəsini yaradan fakturanı idarə edir.

:::info Kontekst
`Bearer` JWT və ya integration token · tenant və filial scope-u · `purchase_invoices`
:::

## Resursun işləmə qaydası

**Məqsəd və sərhəd.** Təchizatçı kreditor borcunu və alış üzrə vergi/mühasibat nəticəsini yaradan fakturanı idarə edir. Bu modul maliyyə nəticəsini və baş kitabı idarə edir; fiziki stok hərəkətinin mənbəyi satış, alış və stok sənədləridir.
...
### Alış fakturaları siyahısını al

**Endpoint** · `GET /api/v1/invoices-in`

Cari istifadəçi və scope daxilində məlumatı dəyişiklik etmədən qaytarır.

**İcazə** · `purchase_invoices.read`
...
{
  "status": "success",
  "message": "Alış fakturaları uğurla siyahılandı.",
  "data": [
    {
      "name": "Nümunə qeyd",
      "state": "draft",
...
### Alış fakturaları qeydi yarat

**Endpoint** · `POST /api/v1/invoices-in`

Sorğudakı məlumatla yeni qeyd və ya resursa aid domain əməliyyatı yaradır.

**İcazə** · `purchase_invoices.create`
...
{
  "status": "success",
  "message": "Alış fakturası yaradıldı.",
  "data": {
    "name": "Nümunə qeyd",
    "state": "draft",
    "branch_id": "44444444-4444-4444-8444-444444444444",
...
### Alış fakturaları state-ni dəyiş

**Endpoint** · `PATCH /api/v1/invoices-in/{id}/state`

Resursun lifecycle vəziyyətini backend keçid qaydalarına uyğun dəyişir.

**İcazə** · `purchase_invoices.__document_transition__`
...
{
  "status": "success",
  "message": "Alış fakturasının vəziyyəti artıq aktualdır.",
  "data": {
    "name": "Nümunə qeyd",
    "state": "draft",
    "branch_id": "44444444-4444-4444-8444-444444444444",
...
### Alış fakturaları qeydini sil

**Endpoint** · `DELETE /api/v1/invoices-in/{invoices_in}`

Qeydi backend-in silmə və bağlı məlumat məhdudiyyətlərinə uyğun arxivləşdirir və ya silir.

**İcazə** · `purchase_invoices.delete`
...
```json
{
  ...
  "path": {
    "invoices_in": "22222222-2222-4222-8222-222222222222"
  },
  "query": {},
  "body": {}
}
...
{
  "status": "success",
  "message": "Alış fakturası silindi.",
  "data": null
}
```
...
### Alış fakturaları qeydini oxu

**Endpoint** · `GET /api/v1/invoices-in/{invoices_in}`
...
{
  "status": "success",
  "message": "Alış fakturası uğurla gətirildi.",
  "data": {
    "name": "Nümunə qeyd",
    "state": "draft",
    "branch_id": "44444444-4444-4444-8444-444444444444",
...
### Alış fakturaları qeydini yenilə

**Endpoint** · `PATCH|PUT /api/v1/invoices-in/{invoices_in}`

Mövcud qeydin göndərilən sahələrini validation və domain qaydalarına uyğun yeniləyir.

**İcazə** · `purchase_invoices.update`
...
{
  "status": "success",
  "message": "Alış fakturası yeniləndi.",
  "data": {
    "name": "Nümunə qeyd",
    "state": "draft",
    "branch_id": "44444444-4444-4444-8444-444444444444",
...
**Endpoint** · `GET /api/v1/purchase-invoices`
...
**Endpoint** · `PATCH /api/v1/purchase-invoices/{id}/state`
...
**Endpoint** · `DELETE /api/v1/purchase-invoices/{purchase_invoice}`
...
```json
{
  ...
  "path": {
    "purchase_invoice": "22222222-2222-4222-8222-222222222222"
  },
  "query": {},
  "body": {}
}
...
**Endpoint** · `GET /api/v1/purchase-invoices/{purchase_invoice}`
...
**Endpoint** · `PATCH|PUT /api/v1/purchase-invoices/{purchase_invoice}`
