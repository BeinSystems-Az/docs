---
sidebar_position: 14
title: Əsas vəsait satışları
---

# Əsas vəsait satışları

Əsas vəsait satışları resursu mühasibatlıq və maliyyə modulunda aid olduğu məlumat və əməliyyatları idarə edir.

:::info Kontekst
`Bearer` JWT və ya integration token · tenant və filial scope-u · `fixed_asset_sales`
:::

## Resursun işləmə qaydası

**Məqsəd və sərhəd.** Əsas vəsait satışları resursu mühasibatlıq və maliyyə modulunda aid olduğu məlumat və əməliyyatları idarə edir. Bu modul maliyyə nəticəsini və baş kitabı idarə edir; fiziki stok hərəkətinin mənbəyi satış, alış və stok sənədləridir.
...
### Əsas vəsait satışları siyahısını al

**Endpoint** · `GET /api/v1/fixed-asset-sales`

Cari istifadəçi və scope daxilində məlumatı dəyişiklik etmədən qaytarır.

**İcazə** · `fixed_asset_sales.read`
...
### Əsas vəsait satışları qeydi yarat

**Endpoint** · `POST /api/v1/fixed-asset-sales`

Sorğudakı məlumatla yeni qeyd və ya resursa aid domain əməliyyatı yaradır.

**İcazə** · `fixed_asset_sales.create`
...
{
  "status": "success",
  "message": "Aktiv satışı yaradıldı.",
  "data": {
    "name": "Nümunə qeyd",
    "state": "draft",
    "branch_id": "44444444-4444-4444-8444-444444444444",
...
### Əsas vəsait satışları qeydini sil

**Endpoint** · `DELETE /api/v1/fixed-asset-sales/{fixedAssetSale}`

Qeydi backend-in silmə və bağlı məlumat məhdudiyyətlərinə uyğun arxivləşdirir və ya silir.

**İcazə** · `fixed_asset_sales.delete`
...
```json
{
  ...
  "path": {
    "fixedAssetSale": "22222222-2222-4222-8222-222222222222"
  },
  "query": {},
  "body": {}
}
...
### Əsas vəsait satışları qeydini oxu

**Endpoint** · `GET /api/v1/fixed-asset-sales/{fixedAssetSale}`
...
### Əsas vəsait satışları qeydini yenilə

**Endpoint** · `PATCH|PUT /api/v1/fixed-asset-sales/{fixedAssetSale}`

Mövcud qeydin göndərilən sahələrini validation və domain qaydalarına uyğun yeniləyir.

**İcazə** · `fixed_asset_sales.update`
...
{
  "status": "success",
  "message": "Aktiv satışı yeniləndi.",
  "data": {
    "name": "Nümunə qeyd",
    "state": "draft",
    "branch_id": "44444444-4444-4444-8444-444444444444",
...
### Əsas vəsait satışları qeydini ləğv et

**Endpoint** · `POST /api/v1/fixed-asset-sales/{fixedAssetSale}/cancel`

Sorğudakı məlumatla yeni qeyd və ya resursa aid domain əməliyyatı yaradır.

**İcazə** · `fixed_asset_sales.cancel`
...
{
  "status": "success",
  "message": "Aktiv satışı ləğv edildi.",
  "data": {
    "name": "Nümunə qeyd",
    "state": "draft",
    "branch_id": "44444444-4444-4444-8444-444444444444",
...
### Əsas vəsait satışları qeydini post et

**Endpoint** · `POST /api/v1/fixed-asset-sales/{fixedAssetSale}/post`

Sorğudakı məlumatla yeni qeyd və ya resursa aid domain əməliyyatı yaradır.

**İcazə** · `fixed_asset_sales.confirm`
...
{
  "status": "success",
  "message": "Aktiv satışı təsdiqləndi.",
  "data": {
    "name": "Nümunə qeyd",
    "state": "draft",
    "branch_id": "44444444-4444-4444-8444-444444444444",
